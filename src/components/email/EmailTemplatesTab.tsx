...
export default function EmailTemplatesTab({ onDataChange }: EmailTemplatesTabProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <p className="text-sm text-gray-500">Saved email templates</p>
          ...
          {templates.map((template) => (
            <div key={template.id} className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
              ...
              <div className="border-t border-gray-100 p-4 bg-slate-50">
                ...
                <div 
                  className="text-xs text-gray-600 max-h-40 overflow-auto leading-relaxed prose prose-sm max-w-none"
