...
function RegisterForm() {
  ...
  return (
    <div className="w-full max-w-[420px] relative z-10 font-outfit">
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-11 bg-gradient-to-r from-blue-600 via-violet-600 to-pink-600 hover:opacity-90 text-white rounded-xl font-semibold text-sm transition-all shadow-lg shadow-violet-200 font-outfit"
            >
              {loading ? (
